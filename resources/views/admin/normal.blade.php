          ...
          <hr>
            ...
            @foreach ($user->normals as $data)
             ...
             <div class="col-sm-3">
              ...
              <div class="col-sm-3">
              <a class="btn btn-danger" type="button" id="delete_normal" data-url ="{{route('delete.normal')}}" data-value="{{$data['id']}}"><i class="glyphicon glyphicon-remove" style="color: #fff"></i></a>
            </div>
               <hr>
           </div>
